...
function Collection() {
    ...
    async function fetchProducts() {
        ...
        // console.log('response @Collection.js', response.data.data);
    }
        ...
        <div className="container">
            <div className="header">
                <div className="info">
                    ...
                    <p>Usa's largest collection of wall posters for your bedroom, living room, kids room, kitchen and posters & art prints at highest quality lowest price guaranteed.</p>
                </div>
